...
const generateTokens = function (memberId,role){
   const accessToken = jwt.sign({memberId,role},process.env.ACCESS_TOKEN_SECRET,{expiresIn :'30m'})
   const refreshToken = jwt.sign({memberId,role},process.env.REFRESH_TOKEN_SECRET,{expiresIn :'7d'})
